...
def instructions(options):
    ...
    if show_help == "Yes":
        ...
        print()
        print("Give your name, give your age, state what snacks you want ")
        print("(popcorn, mms, water, pita chips, orange juice) if you do not want any snacks input xxx,")
        print("choose whether to pay with cash or credit, if you do not want to order another ticket")
        print("upon being asked for another name input xxx")
...
summary_headings = ["Popcorn", "Pita Chips", "Water", "Mms",
...
movie_frame = movie_frame.rename(columns={'Surcharge_Multiplier': 'SM'})
...
print("Summary headings", len(summary_headings))
print(summary_headings)

print("Amount", len(summary_data))
print(summary_data)
